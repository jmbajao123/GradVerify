...
<head>
  ...
  <title>Department List - Credentials Verification Sibugay Technical Institute Inc.</title>
        ...
        <section class="section">
          <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
              ...
              <div class="breadcrumb-item">Department List
          ...
          <div class="section-body">
            <h2 class="section-title">Department List
            ...
            <table class="table table-striped table-md">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="department_info.php?d_id=<?= $row['d_id']; ?>" class="btn btn-secondary">Detail</a></td> <!-- Added dynamic link with department_id -->
                    </tr>
                    <?php 
                        $count++;
                        endwhile; 
		      ...
		      <div class="modal-body">
		       <form method="post" action="department.php">
		       	...
		       	<div class="col-lg-12">
		       		...
		       		<select class="form-control" name="department_status" id="department_status" required>
