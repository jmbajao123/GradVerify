...
<head>
  ...
  <title>Course - Credentials Verification Sibugay Technical Institute Inc.</title>
        ...
        <section class="section">
          <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
              ...
              <div class="breadcrumb-item">Course List
          ...
          <div class="section-body">
            <h2 class="section-title">Course List
            ...
            <table class="table table-striped table-md">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="course_info.php?c_id=<?= $row['c_id']; ?>" class="btn btn-secondary">Detail</a></td> <!-- Added dynamic link with course_id -->
                    </tr>
                    <?php 
                        $count++;
                        endwhile; 
