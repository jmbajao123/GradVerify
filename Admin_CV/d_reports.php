      ...
      <div class="main-content">
        <section class="section">
          <div class="section-header">
            <h1>Department List Reports</h1>
            <div class="section-header-breadcrumb">
              <div class="breadcrumb-item active"> <a href="dashboard.php"> Dashboard </a> </div>
              <!-- <div class="breadcrumb-item"><a href="#">Department List</a></div> -->
              <div class="breadcrumb-item">Department List Reports
          ...
          <div class="section-body">
            <h2 class="section-title">Department List Reports
                <a href="d_print.php" class="btn btn-outline-primary" target="_blank" style="float: right;">Generate</a>
            </h2>
